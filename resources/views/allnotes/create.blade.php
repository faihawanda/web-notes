  ...
  <div class="max-w-3xl mx-auto">
      ...
      <form action="{{ route('allnotes.store') }}" method="POST" class="bg-white rounded-3xl p-8 shadow">
          ...
          <div class="mb-6">
              ...
              <input type="text" name="title" value="{{ old('title') }}" class="w-full border rounded-xl p-3" placeholder="Enter note title">
              @error('title')
          ...
          <div class="mb-6">
              ...
              <textarea name="content" rows="10" class="w-full border rounded-xl p-3" placeholder="Write your note...">{{ old('content') }}</textarea>
              @error('content')
                  <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
              @enderror
          </div>
          ...
          <div class="mb-8">
              <label class="font-semibold block mb-3">Note Category</label>
